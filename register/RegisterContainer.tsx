...
const RegisterContainer = () => {
    ...
    // Function to handle OAuth registration redirects
        ...
        >
            {({ isSubmitting, setSubmitting, submitForm }) => (
                <RegisterFormContainer title={'Registration Form'} css={tw`w-full flex`}>
                    ...
                    {/* Add OAuth Registration Buttons */}
                    <div css={tw`mt-6 flex flex-col items-center`}>
                        <Button
                            type={'button'}
                            size={'xlarge'}
                            css={tw`mb-4 bg-discord text-white`}
